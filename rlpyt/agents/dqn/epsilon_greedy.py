...
class EpsilonGreedyAgentMixin:
    ...
    def __init__(
            ...
            eps_itr_max=1000,
            eps_eval=0.001,
            eps_spacing: Literal["log", "linear"]="log",
            *args,
            **kwargs
            ):
    ...
    def make_vec_eps(self, global_B, env_ranks):
        ...
        if (self.eps_final_min is not None and
            ...
            if self.eps_spacing == "log":
                ...
                global_eps_final = torch.linspace(
                    torch.tensor(self.eps_final_min),
                    torch.tensor(self._eps_final_scalar),
                    global_B) 
